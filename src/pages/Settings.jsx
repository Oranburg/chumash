...
// higher one, so each string describes the learner and the push, and at every
// step she stays the one who decides what the verse means. The middle step is
// the default, the casual scholar the app is built for. Ordered gentler to
// harder.
const LEVELS = [
  {
    name: 'Gentle',
    blurb: 'One more foothold, a slower pace. Good for a hard verse.',
    value:
      'a learner new to studying a verse closely who wants to be met gently. Give one more foothold than usual, slow down, and take one step at a time. Keep her the one who decides what the verse means.',
  },
  {
    name: 'Easing in',
    blurb: 'A little more help than the middle setting.',
    value:
      'a serious but casual scholar who follows the parsha and wants a bit more help. Name the difficulty for her before she has to find it, and bring one commentator at a time.',
  },
  {
    name: 'Casual scholar',
    blurb: 'The default. Follows the parsha, knows the alphabet, looks things up.',
    value: DEFAULT_LEVEL,
  },
  {
    name: 'Pushing',
    blurb: 'Less scaffolding, sharper questions.',
    value:
      'a capable reader who wants to be pushed. Let her find the difficulty before you name it, press on whether a commentator truly resolves it, and bring a second commentator who disagrees.',
  },
  {
    name: 'Hard',
    blurb: 'Minimal scaffolding, the hardest press.',
    value:
      'a strong reader who wants the hardest study. Withhold the easy foothold, hold her to naming the difficulty herself, and set the commentators against each other so she has to weigh the disagreement. She still decides what the verse means.',
  },
];
...
export default function Settings() {
  ...
  // The provider picker saves the moment the reader chooses one, then loads that
  // provider's own saved key, model, and base URL.
  ...
  return (
    <section style={{ maxWidth: 'var(--max-width)', margin: '0 auto', padding: 'var(--space-lg)' }}>
      <h1>Settings</h1>
      ...
      <div className="card">
        ...
        >
          ...
          frontier models. A very small or local model may start fabricating a
          commentator's words, which is the one thing the partner must never do.
        </p>
      ...
      <div className="card">
        <p style={{ marginTop: 0 }}>
          The partner matches its questions to you. Set how much it leans on you
          and how much it helps. A gentler setting names the difficulty for you
          and slows down; a harder setting holds you to finding the difficulty
          yourself and sets the commentators against each other. You decide what
          the verse means at every setting.
        </p>
        <div
          role="group"
      ...
      <div className="card">
        <p style={{ marginTop: 0 }}>
          The verse partner opens the conversation among the commentators about a
          verse. You write what you noticed or found hard first; the partner names
          the difficulty, brings what a commentator proposes for it, and asks what
          you think. It quotes only what Sefaria returns and never invents a
          commentator's words.
        </p>
        <p>
        ...
        <p>
          ...
          <em>Judgment Proof</em>, Chapter 13, and works by Nehama Leibowitz's
          method of asking what is bothering the commentator before reading his
          answer.
        </p>
        <p>
          Every text comes from{' '}
          <a href="https://www.sefaria.org" target="_blank" rel="noreferrer">
            Sefaria
          </a>
          . The Hebrew is the vocalized Torah text; the commentators are Onkelos,
          Rashi, Rashbam, Ibn Ezra, Ramban, and Sforno, each quoted verbatim from
          Sefaria.
        </p>
