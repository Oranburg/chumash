...
//      blanks. We catch that error, clear the service workers and caches once,
//      and reload onto a clean fetch.
//
...
const CONTROLLER_RELOAD_FLAG = 'chumash-sw-controller-reloaded';
const CHUNK_HEAL_FLAG = 'chumash-chunk-heal-attempted';
