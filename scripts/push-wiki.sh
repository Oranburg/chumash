...
WIKI_REPO="https://github.com/Oranburg/chumash.wiki.git"
...
if ! git clone "$WIKI_REPO" "$TMPDIR/wiki" 2>&1; then
  ...
  echo ""
  echo "  https://github.com/Oranburg/chumash/wiki"
  echo ""
...
git commit -m "Publish wiki pages from chumash/wiki/ ($COMMIT_DATE)"

echo "Pushing to $WIKI_REPO ..."
git push origin master

echo ""
echo "Done. Visit https://github.com/Oranburg/chumash/wiki to see the result."
